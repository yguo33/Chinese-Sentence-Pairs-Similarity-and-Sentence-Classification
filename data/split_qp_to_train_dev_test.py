...
def split_files(input_file, output_train_file, output_dev_file, output_test_file):
    ...
    with codecs.open(input_file, 'r', 'utf-8') as f:
        for line in f:
            ...
            if len(line_split) == 3:
                total_qq.append([line_split[0], line_split[1]])
                total_y.append(line_split[2])
